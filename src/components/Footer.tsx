...
const Footer = () => {
  ...
  return (
    <footer className="bg-background border-t border-border/50 pt-16 pb-8 px-6 md:px-12 lg:px-24">
      <RevealOnScroll>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <a href="tel:+916302458752" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                    +91 6302458752
                  </a>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex gap-4 pt-2">
                  <a href="https://www.linkedin.com/company/staclisystems/" target="_blank" rel="noopener noreferrer" className="text-primary transition-opacity"><Linkedin size={20} /></a>
